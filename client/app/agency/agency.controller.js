...
angular.module('MeanApp')
  .controller('PatientDetails11Ctrl', function ($scope,Auth, $rootScope, Patient,Agency, socket, $stateParams, $location, $state, $injector) {
    ...
    $scope.deleteH = function(b){ // success handler
      ...
      {
        b.in="agency";
        b.agency=Auth.getCurrentUser()._id;
      console.log( typeof b.departure_date);
      var agency={};
      ...
      agency.patient_departure_date=b.departure_date;
  ...
  .controller('AgencyCtrl', function ($scope, Auth,Patient, Agency, socket, $rootScope) {
    ...
    $scope.datez=new Date();
    $scope.date2005 = new Date('2005/01/01');
    console.log( typeof datez);
    ...
    $scope.createAgency = function(agency){
      ...
      agency.patient_departure_date=agency.departure_date;
      agency.agency_id= Auth.getCurrentUser()._id ;
      agency.in="agency";
      console.log(agency.agency_id);
      Agency.save(agency).$promise;
    ...
    $scope.comparee = function (agency) {

      console.log("bbbb");
      var aziz= new Date();
      var aziz1= new Date(agency.patient_departure_date);
      console.log(aziz1);
      console.log(aziz);
